...
func NewPurgingReconciler(logger *log.Entry, datastore datastore.Writer, client client.Client) Reconciler {
	return NewPurgingReconcilerWithInterfaceClient(logger, datastore, wrapper.NewClient(client))
}
...
func NewPurgingReconcilerWithInterfaceClient(logger *log.Entry, datastore datastore.Writer, client wrapper.Client) Reconciler {
